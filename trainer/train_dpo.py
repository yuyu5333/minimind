...
from trainer.trainer_utils import get_lr, Logger, is_main_process, lm_checkpoint, init_distributed_mode, setup_seed, init_model, SkipBatchSampler, wrap_model_for_distributed, safe_load_state_dict
...
def train_epoch(epoch, loader, iters, ref_model, lm_config, start_step=0, wandb=None, beta=0.1):
    ...
    for step, batch in enumerate(loader, start=start_step + 1):
        ...
        if (step % args.save_interval == 0 or step == iters - 1) and is_main_process():
            ...
            from trainer.trainer_utils import get_state_dict_for_saving
...
if __name__ == "__main__":
    ...
    if ckp_data:
        safe_load_state_dict(model, ckp_data['model'])
